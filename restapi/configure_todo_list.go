...
import (
	...
	"goSwagger2do/restapi/operations"
	"goSwagger2do/restapi/operations/todos"
)

//go:generate swagger generate server --target ../../goSwagger2do --name TodoList --spec ../swagger.yml
